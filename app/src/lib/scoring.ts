import { DIMENSIONS, type DimensionScores, type Question, type RockProfile, type RocktiResult, type UserAnswerMap } from "../types/rockti";
import { DIMENSION_WEIGHTS } from "../data/dimensions";
...
/** 找出用户得分最高的 3 个维度，用于结果页/海报显示"主导维度"。 */
